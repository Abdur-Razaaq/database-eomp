...
def adminregister():
    ...
    # heading names
    tree.heading("Name", text="No.")
    tree.heading("Id_Number", text="Name")
    tree.heading("Phone_Number", text="Surname")
    tree.heading("Email_Address", text="Cell_Number")
    tree.heading("Time_in", text="ID Number")
        ...
        if user_ent.get() == "" or id_num_ent.get() == "":
            ...
            try:
                ...
                if row == "":
                    ...
                    mycursor.execute(
                        "Delete from User_Info where ID_Number='" + id_num_ent.get() + "' and Name='" + user_ent.get() + "'")
                    mydb.commit()
                    mydb.close()
